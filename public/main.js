...
var User = /** @class */ (function () {
    function User(email, password, firstName, lastName, userName, from, til, paymentId, phone, street, street2, landlord, avatar, admin, banned, request, reject, userRequest, _id) {
        this.email = email;
