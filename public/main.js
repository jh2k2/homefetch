...
var PropertyFormComponent = /** @class */ (function () {
    function PropertyFormComponent(router, propSer, userSer) {
        ...
        this.propSer = propSer;
        this.userSer = userSer;
        this.prop = { deposit: null, rooms: null, area: null, available: null, title: null, description: null, rules: null, bathrooms: null, street: null };
    ...
    PropertyFormComponent.prototype.onSubmit = function () {
        ...
        var property = new _model_property_model__WEBPACK_IMPORTED_MODULE_4__["Property"](this.form.value.deposit, this.form.value.rooms, this.form.value.area, this.form.value.available, this.form.value.title, this.form.value.description, this.form.value.rules, this.form.value.bathrooms, this.form.value.street.name, test, this.form.value.street.vicinity, this.longitude, this.latitude, this.isActive(1), this.isActive(2), this.isActive(3), this.isActive(4), this.isActive(5), this.isActive(6), this.isActive(7), this.isActive(8), this.isActive(9), this.isActive(10), this.isActive(11), this.isActive(12), this.prop.user, this.sendEditedImage(1), this.sendEditedImage(2), this.sendEditedImage(3), this.sendEditedImage(4));
