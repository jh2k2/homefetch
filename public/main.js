...
var Property = /** @class */ (function () {
    function Property(
    //basic info
    deposit, monthly, rooms, area, available, minstay, maxstay, title, description, rules, documents, landlordrules, bathrooms, electricity, water, gas, wifi, street, remain, vicinity, longitude, latitude, address_object, youtube, 
    //icons
...
var PropertyFormComponent = /** @class */ (function () {
    function PropertyFormComponent(router, propSer, userSer) {
        ...
        this.propSer = propSer;
        this.userSer = userSer;
        this.prop = { deposit: null, youtube: null, monthly: null, rooms: null, area: null, available: null, minstay: null, maxstay: null, title: null, description: null, rules: null, documents: null, landlordrules: null, bathrooms: null, remain: null, street: null, electricity: 'included', water: 'included', gas: 'included', wifi: 'included', address_object: null };
    ...
    PropertyFormComponent.prototype.onSubmit = function () {
        ...
        var property = new _model_property_model__WEBPACK_IMPORTED_MODULE_4__["Property"](this.form.value.deposit, this.form.value.monthly, this.form.value.rooms, this.form.value.area, this.form.value.available, this.form.value.minstay, this.form.value.maxstay, this.form.value.title, this.form.value.description, this.form.value.rules, this.form.value.documents, this.form.value.landlordrules, this.form.value.bathrooms, this.form.value.electricity, this.form.value.water, this.form.value.gas, this.form.value.wifi, this.address_object.name, test, this.address_object.vicinity, this.longitude, this.latitude, JSON.stringify(this.address_object), this.form.value.youtube, this.isActive(1), this.isActive(2), this.isActive(3), this.isActive(4), this.isActive(5), this.isActive(6), this.isActive(7), this.isActive(8), this.isActive(9), this.isActive(10), this.isActive(11), this.isActive(12), this.prop.user, this.sendEditedImage(1), this.sendEditedImage(2), this.sendEditedImage(3), this.sendEditedImage(4), this.sendEditedImage(5));
